...
#include <custom_hydra_message/msg/rc_channel_message.h>
...
rcl_publisher_t mult_array_publisher;
custom_hydra_message__msg__RCChannelMessage rc_array_msg;
const char * mult_publisher_topic_name = "/test/array";
...
void timer_callback(rcl_timer_t * timer, int64_t last_call_time)
{
  ...
  if (timer != NULL) 
  {
	...
	rc_array_msg.ch_1 = 100;
	rc_array_msg.ch_2 = 100;
	rc_array_msg.ch_3 = 100;
	rc_array_msg.ch_4 = 100;
	rc_array_msg.ch_5 = 100;
	rc_array_msg.ch_6 = 102;

    RCSOFTCHECK(rcl_publish(&mult_array_publisher, &rc_array_msg, NULL));
