...
static const _RCChannelMessage_type_support_symbol_names_t _RCChannelMessage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_hydra_message, msg, RCChannelMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_hydra_message, msg, RCChannelMessage)),
  }
};
...
{
  return &::custom_hydra_message::msg::rosidl_typesupport_cpp::RCChannelMessage_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, custom_hydra_message, msg, RCChannelMessage)() {
  return get_message_type_support_handle<custom_hydra_message::msg::RCChannelMessage>();
}
