...
#include <custom_hydra_message/msg/RCChannelMessage>
...
const char * mult_publisher_topic_name = "/test/counter_test";
...
void timer_callback(rcl_timer_t * timer, int64_t last_call_time)
{
  ...
  if (timer != NULL) 
  {
    ...
    RCSOFTCHECK(rcl_publish(&mult_array_publisher, &msg, NULL));
...
void setup() {
	...
	&node,
	ROSIDL_GET_MSG_TYPE_SUPPORT(std_msgs, msg, RCChannelMessage),
